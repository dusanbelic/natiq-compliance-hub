          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-[55%] text-center lg:text-left">
              ...
              <p className="text-lg sm:text-xl mb-8 max-w-xl" style={{ color: '#CBD5E1' }}>
                NatIQ uses AI to track your Saudisation, Emiratisation, and Qatarisation ratios in real time and tells you exactly what to do to stay compliant.
              </p>
              ...
              {/* View Live Demo */}
              <div className="mt-4">
                <Button variant="outline" size="lg" className="rounded-full border-primary/40 text-primary hover:bg-primary hover:text-primary-foreground hover:border-primary text-base px-8 py-3 transition-colors duration-300" asChild>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div key={b.label} className="text-center">
                ...
                <p className="text-base leading-snug" style={{ color: '#CBD5E1' }}>{b.desc}</p>
              </div>
            )}
          </div>
